    ...
    <div className="App">
      ...
      <div className="max-w-6xl mx-auto p-4 mt-10 mb-20 relative z-10">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
          <div className="mb-4">
            <label htmlFor="location" className="block text-gray-700 text-sm font-bold mb-2">To</label>
          ...
          <div className="mb-4">
            <label htmlFor="date" className="block text-gray-700 text-sm font-bold mb-2">To</label>
            <div className="flex items-center border border-gray-300 rounded-md">
              <input type="date" id="date" className="flex-grow p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" aria-describedby="date-icon" />
            </div>
      ...
      <div className="bg-white">
        <div className="max-w-6xl mx-auto p-4 mt-10 mb-10">
